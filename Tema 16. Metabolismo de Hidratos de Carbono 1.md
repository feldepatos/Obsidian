...
| Paso | Reacción                                              | Tipo de reacción                            | Enzima que lo lleva a cabo              |
| ---- | ----------------------------------------------------- | ------------------------------------------- | --------------------------------------- |
...
El problema que resuelve es el mismo que otras lanzaderas: durante la glucólisis se produce NADH en el citosol, pero ese NADH debe “entregar” sus electrones a la cadena de transporte de electrones en la mitocondria para generar ATP, y además el NAD+ debe regenerarse para que la glucólisis continúe.

El funcionamiento es el siguiente:

En el citosol, el oxalacetato se reduce a malato mediante la enzima malato deshidrogenasa citosólica. En este proceso, el NADH se oxida a NAD+, lo que permite que continúe la glucólisis. El malato sí puede atravesar la membrana interna mitocondrial.

Una vez dentro de la matriz mitocondrial, el malato se vuelve a oxidar a oxalacetato mediante la malato deshidrogenasa mitocondrial. Aquí se genera NADH dentro de la mitocondria, que ya puede entrar directamente en la cadena de transporte de electrones y producir ATP de forma eficiente.

El oxalacetato no puede salir directamente de la mitocondria, así que se transforma en aspartato mediante transaminación. El aspartato sí puede salir al citosol, donde se reconvierte de nuevo en oxalacetato, cerrando el ciclo.

En cuanto al rendimiento energético, esta lanzadera es más eficiente porque el NADH citosólico termina convertido en NADH mitocondrial, lo que produce aproximadamente 2,5 ATP por NADH.

En resumen, la lanzadera malato-aspartato transfiere electrones del NADH citosólico a la mitocondria regenerando NAD+ en el citosol y formando NADH dentro de la matriz, lo que permite una mayor producción de ATP que la lanzadera del glicerol-3-fosfato.
...
*El oxaloacetato se transporta al citoplasma y se convierte en fosfoenolpiruvato.*
...
*Seis grupos fosforil con alto potencial de transferencia se gastan en la síntesis de glucosa a partir del piruvato.*
...
*La epinefrina y el glucagón señalan la necesidad de la degradación del glucógeno.*
...
Las reacciones anteriores producen dos moléculas de NADPH y una molécula de ribulosa 5-fosfato por cada molécula de glucosa 6-fosfato oxidada. La ribulosa 5-fosfato se isomeriza posteriormente a ribosa 5-fosfato por la fosfopentosa isomerasa.
...
*El dióxido de carbono reacciona con la ribulosa 1,5-bisfosfato para formar dos moléculas de 3-fosfoglicerato.*
...
Como se indica en la página 355, el paso limitante en el ciclo de Calvin es la carboxilación de la ribulosa 1,5-bisfosfato para formar dos moléculas de 3-fosfoglicerato.
![[Pasted image 20250321213214.png]]
Este paso es catalizado por la rubisco, una enzima de acción muy lenta. La actividad de la rubisco aumenta notablemente con la exposición a la luz. ¿Cómo modifican las reacciones luminosas la actividad de la rubisco? Recordemos que el CO₂ debe añadirse a la lisina 201 de la rubisco para formar el carbamato, que es esencial para la actividad catalítica (p. 355). La formación de carbamato se ve favorecida por un pH alcalino y altas concentraciones de iones Mg₂₄ en el estroma, ambos consecuencia del bombeo de protones impulsado por la luz desde el estroma hacia el espacio tilacoide. La concentración de iones magnesio aumenta porque los iones Mg₂₄ del espacio tilacoide se liberan al estroma para compensar la afluencia de protones.
Por lo tanto, la luz genera señales reguladoras, así como ATP y NADPH.

*La tiorredoxina desempeña un papel clave en la regulación del ciclo de Calvin.*

Las reacciones impulsadas por la luz conducen a la transferencia de electrones del agua a la ferredoxina y, finalmente, al NADPH. Tanto la ferredoxina reducida como el NADPH regulan las enzimas del ciclo de Calvin. Una proteína importante en estos procesos reguladores es la tiorredoxina, una proteína de 12 kDa que contiene residuos de cisteína adyacentes. La tiorredoxina cicla entre una forma oxidada con un enlace disulfuro entre las dos cisteínas y una forma sulfhidrilo reducida (Figura 22.17).
En los cloroplastos, la tiorredoxina oxidada es reducida por la ferredoxina en una reacción catalizada por la ferredoxina-tiorredoxina reductasa. La forma reducida de la tiorredoxina activa la rubisco y otras enzimas del ciclo de Calvin, así como muchas enzimas de otras vías metabólicas celulares, mediante la reducción de los puentes disulfuro que controlan su actividad (Tabla 22.1). Por lo tanto, las actividades de las reacciones de luz y oscuridad de la fotosíntesis se coordinan mediante la transferencia de electrones de la ferredoxina reducida a la tiorredoxina y, posteriormente, a las enzimas que la componen, que contienen enlaces disulfuro reguladores (Figura 22.18).
