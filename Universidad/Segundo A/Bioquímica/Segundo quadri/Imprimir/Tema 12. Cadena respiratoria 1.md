...
La subunidad II  del complejo  IV contiene 2 iones Cu que forman con los grupos -SH de 2 residuos Cys en un centro binuclear que se parece a los centros 2Fe-2S de las proteínas ferro-sulfuradas. La subunidad I contiene 2 grupos hemo, designados *a* y *a3*, y otro ión cobre(Cu3). El hemo *a3* y el Cub forman un segundo centro binuclear que acepta los electrones del *hemo a* y los transfiere al O2 unido al hemo *a3*. 
...
Esta reducción de 1/2 O2, por 2 electrones requiere la oxidación de QH2, la cual, a su vez, requiere la oxidación de NADH a succinato. En el complejo IV, el O2 se reduce en centro redox que transportan solo un electrón a la vez. 
...
> [!question] ¿Cómo se organizan los diversos transportadores de electrones para producir una reacción exergónica que finalmente genera un gradiente de protones?
> 

 Los electrones se transfieren del NADH al O₂ a través de una cadena de tres grandes complejos proteicos llamados *NADH-Q oxidorreductasa, Q-citocromo c oxidorreductasa y citocromo c oxidasa* (Figura 19.10 y Tabla 19.2).
...
**El ubiquinol es el punto de entrada de electrones desde FADH₂ en las flavoproteínas.**
...
**La citocromo c oxidasa cataliza la reducción del oxígeno molecular a agua.**
