...
# Características a cumplir  sobre la naturaleza del material hereditario
1. Almacenar información compleja.
2. Replicarse: transmisión precisa de la información a la descendencia.
3. Expresar la información almacenada, con tal de controlar el desarrollo y funcionamiento de un organismo.
4. Experimentar cambios (mutación→variación→evolución).
...
El experimento de **Frederick Griffith (1928)** **demostró** el fenómeno de la **transformación bacteriana**, usando dos cepas de _Streptococcus pneumoniae_: la cepa **S virulenta** (lisable, produce enfermedad) y la cepa **R no virulenta** (no lisable, no produce enfermedad); al inyectar ratones con bacterias vivas S murió el ratón, con R vivas sobrevivió, con S muertas por calor sobrevivió, pero al mezclar **S muertas con R vivas** el ratón murió y se recuperaron bacterias S vivas, lo que mostró que **alguna “sustancia transformante” de las células S muertas pasó a las R y las convirtió en virulentas**, identificándose más tarde como **ADN**.


> [!NOTE] Cruces
> S viva→ratón muerto
> R vivo→ratón vivo
> S muertas(por calor)→ratón vivo
...
**Solo el DNA entra en la bacteria y se transmite a la progenie del fago.**

 T2 está formado por una cubierta proteica que envuelve un núcleo de DNA. 
 El fago entra en contacto con la célula bacteriana en la que introduce alguno de sus componentes. Después de la infección, la información vírica “recluta” la maquinaria celular del huésped para llevar a cabo su reproducción. En un período de tiempo razonablemente corto, se ensamblan muchos fagos nuevos, la célula bacteriana se lisa y los descendientes del virus se liberan. Este proceso se denomina ciclo lítico.

En 1952, Alfred Hershey y Martha Chase publicaron los resultados de unos experimentos destinados a resolver los sucesos que conducen a la reproducción de los fagos. 

Chase conocía que:
- T2 estaban formados por 50% de ADN y proteínas
- La infección se iniciaba por la unión de las fibras de la cola del fago en la célula bacteriana.
- La producción de nuevos virus se daba dentro de la célula bacteriana.

Parecía que algún componente molecular del fago, ya sea el ADN o la proteína eran los causantes.¿Pero cuál era? Porque debemos tener en cuenta que se consideraba a la proteína como estructura transmisora de la información genética por su complejidad estructural y su papel en la estructuras. Recién habían descubierto que el ADN tenía poder transformante(ellos lo consideraban muy simple y repetitivo).
...
Es decir, intercambiaron el ARN entre las 2 plantas así como sus proteínas de distintas cepas del TMV, formaron virus híbridos que contendrían el ARN propio y las proteínas del otro, y viceversa. Esto permitió que el ARN estuviera protegido por la cápside para poder infectar las plantas.
...
- Transmisión de la información genética+ cómo funcinoa los genes
- Regulación de la expresión génica.

Motivos que permite la interacción

- Hélice-giro-hélice
	- Formado por 2 regiones de estructura alpha hélice separadas por un corto segmento de la cadena polipeptídica que permite el giro de las cadenas.
		- Estas proteínas regulan genes implicados en desarrollo.
- Cremalleras de leucinas
	- Son unas regiones polipeptidicas que presentan 4 o 5 leucinas separadas entre ellos por un set de aa en una región de estructura de hélice alpha, toda posibildiad que todas las leucinas se situan en el mismo costado de la hélice.
		- Estas proteínas regulan genes implicados en la división celular.
- Hélice-lazo-hélice
	- Es el motivo anfipático "hélice-lazo-hélice" cada hélice presenta un costado con residuos hidrofóbicos y otro costado con residuos con carga.
- "Dedos de zinc"
	- Puede estar definido como una proyección de unos 30 aa que recuerdan a un dedo
	- Presenta en su base 4 residuos de cisteinas o 2 cisteinas junto con 2 histidinas unidas por un ión de zinc.
- Cys2/his2
- Cys/Cys2
	- Receptores de esteroides.
		- Son un grupo por su relación funcional: cada receptor se activa para la unión con un esteroide particular.
		- Presentan una organización similar:
			- Una región N-terminal
				- Poco conservadas necesaria para la activación de la transcripción.
			- Una región central.
				- Donde se localiza el dominio con el DNA, con una conservación variable.
			- Una región C-terminal.
				- Responsable de la unión a la hormona con una conservación de secuencia que reflejan la especificidad para las distintas hormonas.